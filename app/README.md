...
- **系统托盘 (Tray Icon)** — 常驻系统托盘，支持左键单击/右键菜单交互
- **隐藏到托盘** — 关闭窗口时自动隐藏到系统托盘而非退出，后台持续运行
- **托盘右键菜单** — 提供「显示窗口」和「退出」两个菜单项
- **左键点击恢复窗口** — 左键单击托盘图标即可唤出主窗口并获取焦点
- **窗口定制** — 自定义窗口标题为 "OopsAssistant"，初始尺寸 800×600，支持窗口缩放
